...
def makeQ(new_quest):
    ...
    if xAlg.q_type == 1:
      ...
      syslog.syslog("X: %s" % (xAlg.x))
      syslog.syslog("Y: %s" % (xAlg.y))
    elif xAlg.q_type == 2:
      ...
      syslog.syslog("Q: %s" % (xAlg.expQuestion))
      syslog.syslog("X^2: %s" % (xAlg.x_squared))
      syslog.syslog("XY: %s" % (xAlg.x_y))
      syslog.syslog("Y^2: %s" % (xAlg.y_squared))
    elif xAlg.q_type == 3:
